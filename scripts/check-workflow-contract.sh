...
if [[ "$current_package_phase" == "TRINE_LOGIC_V4_1_ASSET_CARD_LIVE_SIGNAL_CLOSURE_AUTHORIZATION" ]]; then
  ...
  [[ "$(path_list_fingerprint "$authorized_next_package_allowed_paths")" == "e029dfa6ed68f7c68df95f99fcf211d6e210c55c" ]] || fail "Web live direction and risk closure implementation allowlist fingerprint mismatch"
  ...
  [[ "$(yaml_value docs/CODEX_NEXT_TASK.yml web_runtime_truth_plan_implementation_allowlist_count)" == "61" && "$(yaml_value docs/CODEX_NEXT_TASK.yml web_runtime_truth_plan_gate_allowlist_count)" == "10" ]] || fail "runtime truth registered path counts mismatch"
  [[ "$(yaml_value docs/CODEX_NEXT_TASK.yml web_runtime_truth_plan_implementation_allowlist_fingerprint)" == "e029dfa6ed68f7c68df95f99fcf211d6e210c55c" && "$(yaml_value docs/CODEX_NEXT_TASK.yml web_runtime_truth_plan_gate_allowlist_fingerprint)" == "935d97dd7525424f366e3c86610e867b72081208" ]] || fail "runtime truth registered fingerprints mismatch"
