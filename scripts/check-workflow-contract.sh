...
require_file "docs/GITHUB_NATIVE_WORKFLOW.md"
require_file "docs/STALE_PR_ISSUE_HYGIENE.md"
require_file "docs/P291E.md"
require_file "docs/P291G.md"
require_file "docs/P291H.md"
...
require_contains "docs/WORKFLOW_COMMAND_AUTOMATION.md" "bash scripts/v1.sh"
require_contains "docs/WORKFLOW_COMMAND_AUTOMATION.md" "bash scripts/v1-auto.sh"
require_contains "docs/WORKFLOW_COMMAND_AUTOMATION.md" "bash scripts/v1-merge-current.sh"
require_contains "docs/WORKFLOW_COMMAND_AUTOMATION.md" "GitHub-native"
require_contains "scripts/v1-merge-current.sh" "MERGE_CURRENT_DISABLED_REQUIRE_EXPLICIT_PR"
require_contains "scripts/v1-auto.sh" "No active PR"
require_contains "AGENTS.md" "Open PR / branch / Issue"
