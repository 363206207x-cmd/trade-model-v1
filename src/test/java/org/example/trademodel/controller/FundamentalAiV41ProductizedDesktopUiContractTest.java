...
class FundamentalAiV41ProductizedDesktopUiContractTest {
    ...
    void centralizedSemanticMapperOwnsEveryFrozenUserFacingState() throws Exception {
        ...
        assertThat(contract).contains(
                ...
                "NO_COMPLETE_PLAN: Object.freeze({ label: \"暂无最终执行计划\"",
                "WAITING_ANALYSIS: Object.freeze({ label: \"等待分析\"",
                "INSUFFICIENT_DATA: Object.freeze({ label: \"数据不足\"",
                "STALE: Object.freeze({ label: \"数据已过期\"",
                "RULE_VETOED: Object.freeze({ label: \"规则校验未通过\"",
                "AI_UNAVAILABLE: Object.freeze({ label: \"AI解释暂不可用\"",
                "PREPARATION: Object.freeze({ label: \"等待触发\"",
                "OBSERVATION: Object.freeze({ label: \"当前仅观察\"",
                "BLOCKED: Object.freeze({ label: \"当前已阻断\"",
                "READY: Object.freeze({ label: \"分析完成\"",
                "PARTIAL: Object.freeze({ label: \"部分结果可用\"",
                "FALLBACK: Object.freeze({ label: \"当前使用规则降级结果\"",
                "UNAVAILABLE: Object.freeze({ label: \"当前分析不可用\"",
