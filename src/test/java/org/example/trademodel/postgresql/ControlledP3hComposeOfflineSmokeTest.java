...
class ControlledP3hComposeOfflineSmokeTest {
    ...
    void disposableComposeProvesBootstrapSecretsProxyAndReadOnlyRole() throws Exception {
        ...
        assertThat(output).contains(
                ...
                "RECOVERY_CONFIRMATION_STATUS: REQUIRED_AND_PROVEN",
                ...
                "READONLY_ROLE_MEMBERSHIP_CONTRACT: PASS",
                "READONLY_DEFAULT_ACL_CONTRACT: PASS",
                "READONLY_SEQUENCE_PRIVILEGE_CONTRACT: PASS",
