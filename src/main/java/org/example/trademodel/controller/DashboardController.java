...
public class DashboardController {
    ...
    public Map<String, Object> recheckPreviewStatus(
        ...
        applyRecheckPreviewStatus(
                ...
                "RAW_PUSH_RECHECK_READ_DISABLED",
                "PushRecheck preview has no authoritative source-owner relationship and remains unavailable.",
                true,
                "BLOCKED"
        );
        return status;
    ...
    private Map<String, Object> baseRecheckPreviewStatus(
        ...
        status.put("ownerPath", "disabled until an exact POSITION_RISK owner relationship exists");
        status.put("projectionScope", "fail-closed status only; no raw Push/Recheck projection");
        status.put("sourceHealth", "MISSING");
        status.put("opsOverviewAvailable", false);
        status.put("statusContractMeaning", "private Push/Recheck data is unavailable without exact owner identity");
