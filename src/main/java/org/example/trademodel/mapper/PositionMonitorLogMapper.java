...
public interface PositionMonitorLogMapper {
    ...
    String BASE_SELECT = "SELECT log_id AS logId, position_id AS positionId, analysis_id AS analysisId, "
            ...
            + "risk_level AS riskLevel, suggested_action AS suggestedAction, "
    ...
    String OWNER_SCOPED_SELECT = "SELECT l.log_id AS logId, l.position_id AS positionId, "
            ...
            + "l.risk_change_reason AS riskChangeReason, l.risk_level AS riskLevel, "
    ...
    @Insert("INSERT INTO tm_position_monitor_log("
            ...
            + "entry_logic_status, monitor_conclusion, reversal_status, risk_change_reason, risk_level, "
            ...
            + "#{entryLogicStatus}, #{monitorConclusion}, #{reversalStatus}, #{riskChangeReason}, #{riskLevel}, "
