package org.example.trademodel.dto.evidence;

import java.util.ArrayList;
import java.util.List;

public class ReviewOnlyNormalizedEvidenceDTO {
    ...
    private final String evidenceEntryStatus;
    ...
    private ReviewOnlyNormalizedEvidenceDTO(
            String symbol,
            String requestId,
        ...
        this.evidenceEntryStatus = evidenceEntryStatus;
    ...
    public static ReviewOnlyNormalizedEvidenceDTO reviewOnly(
            String symbol,
            String requestId,
            String sourceContractId,
            String watchlistPoolProof,
        ...
        return new ReviewOnlyNormalizedEvidenceDTO(
                symbol,
                requestId,
                sourceContractId,
                watchlistPoolProof,
    ...
    public static ReviewOnlyNormalizedEvidenceDTO blocked(
            String symbol,
            String requestId,
            String sourceContractId,
            String watchlistPoolProof,
    ...
    public String getEvidenceEntryStatus() {
        return evidenceEntryStatus;
    }
