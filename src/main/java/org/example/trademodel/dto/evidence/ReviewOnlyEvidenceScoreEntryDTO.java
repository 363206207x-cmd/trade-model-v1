...
public class ReviewOnlyEvidenceScoreEntryDTO {
    ...
    private ReviewOnlyEvidenceScoreEntryDTO(
            String symbol,
            String requestId,
    ...
    public static ReviewOnlyEvidenceScoreEntryDTO reviewOnly(
            String symbol,
            String requestId,
            String sourceContractId,
            String watchlistPoolProof,
        ...
        return new ReviewOnlyEvidenceScoreEntryDTO(
                symbol,
                requestId,
                sourceContractId,
                watchlistPoolProof,
    ...
    public static ReviewOnlyEvidenceScoreEntryDTO blocked(
            String symbol,
            String requestId,
            String sourceContractId,
            String watchlistPoolProof,
