...
- Current HEAD: `bcbeb15 docs(risk): gate account exposure implementation readiness`.
- Active stop-loss track: `Minimal Review-Only Account Risk / Account Exposure Status Runtime Wiring Verification`.
...
- Next required action: `Minimal Review-Only Account Risk / Account Exposure Status Runtime Wiring Verification`.
...
- The next required action is `Minimal Review-Only Account Risk / Account Exposure Status Runtime Wiring Verification`.
