...
- P256 已完成：Candidate Attention Review-Only Skeleton（候选关注只允许复核骨架）。
- P257 当前推进：Opportunity Push Authorization and Risk Guard Gate Pack（机会推送授权与风险保护门包）。
- P257 是 docs-only gate pack，不是实现。
