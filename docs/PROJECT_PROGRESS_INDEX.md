...
- Current HEAD: `c7fb97e docs(risk): verify implementation readiness (#932)`.
- Active stop-loss track: `Minimal Review-Only RiskActionGuard Read-Only Status Runtime Wiring Verification`.
