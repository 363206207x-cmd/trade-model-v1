...
- Current HEAD: `16dabe4 docs(risk): verify account exposure runtime wiring (#976)`.
- Active stop-loss track: `Next minimal runtime slice selection after Account Risk / Account Exposure Status closure`.
- Selected target: `Next minimal runtime slice selection`.
...
- Selected next minimal runtime slice: `TBD by next selection package`.
- Next required action: `Next minimal runtime slice selection after Account Risk / Account Exposure Status closure`.
...
- Selected next minimal runtime slice is `TBD by next selection package`.
- The next required action is `Next minimal runtime slice selection after Account Risk / Account Exposure Status closure`.
