...
- Current HEAD: `f32c276 docs(runtime): gate internal push preview readiness (#994)`.
- Active stop-loss track: `Minimal Review-Only Internal Push Preview / Notification Preview Status Runtime Wiring Implementation`.
...
- Next required action: B-risk Draft PR review for `Minimal Review-Only Internal Push Preview / Notification Preview Status Runtime Wiring Implementation`; after merge, `Minimal Review-Only Internal Push Preview / Notification Preview Status Runtime Wiring Verification`.
