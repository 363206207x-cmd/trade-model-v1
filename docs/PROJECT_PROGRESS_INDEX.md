...
- Current HEAD: `ea84df3 docs(runtime): select internal push preview source read (#991)`.
- Active stop-loss track: `Minimal Review-Only Internal Push Preview / Notification Preview Status Runtime Wiring Design`.
