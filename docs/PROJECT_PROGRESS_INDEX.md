...
- `P347 SourceOwnedCandidateIntegrationSourceBindingValidator Verification` is active on branch `p347`.
...
- The active block is SourceOwnedCandidateIntegrationSourceBindingValidator Verification.
- The next required business action is `P348 SourceOwnedCandidateIntegrationSourceBindingAssembler Plan`.
...
Near-term priority after merged P346 / active P347:

1. Complete P347 SourceOwnedCandidateIntegrationSourceBindingValidator Verification.
2. P348 SourceOwnedCandidateIntegrationSourceBindingAssembler Plan.
