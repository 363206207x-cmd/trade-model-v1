...
- Current HEAD: `4d4a675 docs(runtime): verify hot reset event readiness`.
- Active stop-loss track: `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Implementation`.
...
- Next required action: B-risk review of the implementation Draft PR, then `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Verification` after merge.
