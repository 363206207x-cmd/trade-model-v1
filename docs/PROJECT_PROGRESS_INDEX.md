...
- P275 当前推进：External Channel Closure and CI Exception Record Scope Pack（external channel 收口与 CI 例外记录范围包）。
...
- external channel closure and CI exception record（external channel 收口与 CI 例外记录）当前推进；下一阶段推荐返回 real scan / real score / Candidate / Push preview planning。
