...
- Current HEAD: `1d87e1d docs(risk): read account exposure source path`.
- Active stop-loss track: `Implementation readiness gate for Account risk / account exposure status`.
...
- The next required action is `Implementation readiness gate for Account risk / account exposure status`.
