...
- `P343 Source-Owned Candidate Integration Boundary Plan` is active on branch `p343`.
...
- The active block is Source-Owned Candidate Integration Boundary Plan.
- The next required business action is `P344 Source-Owned Candidate Integration Source Binding Plan`.
...
Near-term priority after merged P342 / active P343:

1. Complete P343 Source-Owned Candidate Integration Boundary Plan.
2. P344 Source-Owned Candidate Integration Source Binding Plan.
