...
- Current HEAD: `07d37de feat(push): show internal push preview review-only status`.
- Active stop-loss track: `Minimal Review-Only Internal Push Preview / Notification Preview Status Runtime Wiring Verification`.
...
- Next required action: `Minimal Review-Only Internal Push Preview / Notification Preview Status Runtime Wiring Verification`; after merge, `Internal Push Preview / Notification Preview Status Visual Verification / Closure`.
