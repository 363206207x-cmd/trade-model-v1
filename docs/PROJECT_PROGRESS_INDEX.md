...
- `P351 Source-Owned Candidate Integration Runtime Boundary Plan` is active on branch `p351`.
...
- The active block is Source-Owned Candidate Integration Runtime Boundary Plan.
- The next required business action is `P352 Source-Owned Candidate Integration Runtime Input Contract Plan`.
...
Near-term priority after merged P350 / active P351:

1. Complete P351 Source-Owned Candidate Integration Runtime Boundary Plan.
2. P352 Source-Owned Candidate Integration Runtime Input Contract Plan.
