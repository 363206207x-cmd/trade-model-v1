...
- `P345 SourceOwnedCandidateIntegrationSourceBindingDTO Java Skeleton` is active on branch `p345`.
...
- The active block is SourceOwnedCandidateIntegrationSourceBindingDTO Java Skeleton.
- The next required business action is `P346 SourceOwnedCandidateIntegrationSourceBindingValidator Java Skeleton`.
...
Near-term priority after merged P344 / active P345:

1. Complete P345 SourceOwnedCandidateIntegrationSourceBindingDTO Java Skeleton.
2. P346 SourceOwnedCandidateIntegrationSourceBindingValidator Java Skeleton.
