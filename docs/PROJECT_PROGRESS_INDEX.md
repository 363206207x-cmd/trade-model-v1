...
- Current HEAD: `40a84e3 docs(recheck): design preview status runtime wiring (#1000)`.
- Active stop-loss track: `Implementation readiness gate for Recheck preview / recheck status`.
...
- Next required action: `Implementation readiness gate for Recheck preview / recheck status`; after merge, `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Implementation`.
