...
- Current HEAD: `00cee60 docs(runtime): read hot reset event source path`.
- Active stop-loss track: `Implementation readiness gate for Hot Reset / Event Impact Source review-only status`.
...
- Next required action: `Implementation readiness gate for Hot Reset / Event Impact Source review-only status`.
