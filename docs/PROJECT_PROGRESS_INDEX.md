...
- `P355 Source-Owned Candidate Integration Runtime Validator Plan` is active on branch `p355`.
...
- The active block is Source-Owned Candidate Integration Runtime Validator Plan.
- The next required business action is `P356 Source-Owned Candidate Integration Runtime Validator Java Skeleton`.
...
Near-term priority after merged P354 / active P355:

1. Complete P355 Source-Owned Candidate Integration Runtime Validator Plan.
2. P356 Source-Owned Candidate Integration Runtime Validator Java Skeleton.
