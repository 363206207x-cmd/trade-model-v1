...
- Current HEAD: `8069a48 docs(runtime): record runtime readiness visual closure`.
- Active stop-loss track: `Source Read for Account risk / account exposure status`.
...
- The next required action is `Source Read for Account risk / account exposure status`.
