...
- `P352 Source-Owned Candidate Integration Runtime Input Contract Plan` is active on branch `p352`.
...
- The active block is Source-Owned Candidate Integration Runtime Input Contract Plan.
- The next required business action is `P353 Source-Owned Candidate Integration Runtime DTO Plan`.
...
Near-term priority after merged P351 / active P352:

1. Complete P352 Source-Owned Candidate Integration Runtime Input Contract Plan.
2. P353 Source-Owned Candidate Integration Runtime DTO Plan.
