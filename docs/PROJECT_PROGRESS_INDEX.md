...
- `P344 Source-Owned Candidate Integration Source Binding Plan` is active on branch `p344`.
...
- The active block is Source-Owned Candidate Integration Source Binding Plan.
- The next required business action is `P345 SourceOwnedCandidateIntegrationSourceBindingDTO Java Skeleton`.
...
Near-term priority after merged P343 / active P344:

1. Complete P344 Source-Owned Candidate Integration Source Binding Plan.
2. P345 SourceOwnedCandidateIntegrationSourceBindingDTO Java Skeleton.
