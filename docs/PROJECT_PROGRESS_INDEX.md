...
- `P338 RuntimeKlineContextSourceBindingAssembler And Verification` is active on branch `p338`.
...
- The active block is RuntimeKlineContextSourceBindingAssembler And Verification.
- The next required business action is `DataQualityContext Source Binding Plan` or a DataQuality DTO+Validator+Assembler capability closure.
...
Near-term priority after merged P337 / active P338:

1. Complete P338 RuntimeKlineContextSourceBindingAssembler And Verification.
2. DataQualityContext Source Binding Plan or DataQuality DTO+Validator+Assembler capability closure.
