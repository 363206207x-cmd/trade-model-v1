...
- `P333 SourceTrace Runtime / Source Binding Plan` is available on branch `p333`.
- `P334 SourceTrace Runtime / Source Binding Verification` is active on branch `p334`.
...
- The active block is SourceTrace Runtime / Source Binding Verification.
- The next required action is `P335 SourceTrace Runtime Binding Contract / DTO Plan`.
