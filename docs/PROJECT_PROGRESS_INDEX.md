...
- `P349 SourceOwnedCandidateIntegrationSourceBindingAssembler Java Skeleton` is active on branch `p349`.
...
- The active block is SourceOwnedCandidateIntegrationSourceBindingAssembler Java Skeleton.
- The next required business action is `P350 SourceOwnedCandidateIntegrationSourceBindingAssembler Verification`.
...
Near-term priority after merged P348 / active P349:

1. Complete P349 SourceOwnedCandidateIntegrationSourceBindingAssembler Java Skeleton.
2. P350 SourceOwnedCandidateIntegrationSourceBindingAssembler Verification.
