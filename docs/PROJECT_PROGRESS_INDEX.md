...
- `P354 Source-Owned Candidate Integration Runtime DTO Java Skeleton` is active on branch `p354`.
...
- The active block is Source-Owned Candidate Integration Runtime DTO Java Skeleton.
- The next required business action is `P355 Source-Owned Candidate Integration Runtime Validator Plan`.
...
Near-term priority after merged P353 / active P354:

1. Complete P354 Source-Owned Candidate Integration Runtime DTO Java Skeleton.
2. P355 Source-Owned Candidate Integration Runtime Validator Plan.
