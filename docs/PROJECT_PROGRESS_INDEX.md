...
- Current HEAD: `5d975fb feat(runtime): show runtime readiness guardrail status`.
- Active stop-loss track: `Runtime Readiness / System Guardrail Status Visual Verification / Closure`.
