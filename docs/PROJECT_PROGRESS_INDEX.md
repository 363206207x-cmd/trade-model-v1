...
- Current HEAD: `3dfd350 docs(recheck): read preview status source path (#999)`.
- Active stop-loss track: `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Design`.
...
- Next required action: `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Design`; after merge, `Implementation readiness gate for Recheck preview / recheck status`.
