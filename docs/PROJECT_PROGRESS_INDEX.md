...
- `P333 SourceTrace Runtime / Source Binding Plan` is active on branch `p333`.
...
- The active block is SourceTrace Runtime / Source Binding Plan.
- The next required action is `review_p333_docs_only_plan`.
