...
- Current HEAD: `e7de3e3 docs(review): verify review archive aggregate runtime wiring`.
- Active stop-loss track: `Next minimal runtime slice selection after Review Archive Analytics / Missed Opportunity Aggregate Status closure`.
- Selected target: TBD by `Next minimal runtime slice selection after Review Archive Analytics / Missed Opportunity Aggregate Status closure`.
...
- Selected next minimal runtime slice: to be selected by `Next minimal runtime slice selection after Review Archive Analytics / Missed Opportunity Aggregate Status closure`.
