...
- `P353 Source-Owned Candidate Integration Runtime DTO Plan` is active on branch `p353`.
...
- The active block is Source-Owned Candidate Integration Runtime DTO Plan.
- The next required business action is `P354 Source-Owned Candidate Integration Runtime DTO Java Skeleton`.
...
Near-term priority after merged P352 / active P353:

1. Complete P353 Source-Owned Candidate Integration Runtime DTO Plan.
2. P354 Source-Owned Candidate Integration Runtime DTO Java Skeleton.
