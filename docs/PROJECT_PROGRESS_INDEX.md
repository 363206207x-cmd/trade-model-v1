...
- Current HEAD: `5d25e53 docs(risk): design risk action guard read-only wiring (#931)`.
- Active stop-loss track: `Minimal Review-Only RiskActionGuard Read-Only Status Runtime Wiring Implementation`.
