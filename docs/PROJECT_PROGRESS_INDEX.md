...
- Current HEAD: `8504cb1 feat(review): show review archive aggregate status`.
- Active stop-loss track: `Review Archive Analytics / Missed Opportunity Aggregate Status Visual Verification / Closure`.
