...
- P276 当前推进：Real Scan Score Candidate Return Scope Pack（real scan / real score / Candidate / Push preview planning 范围包）。
...
- Future recommended next package after P276 should be real scan contract audit / market-read boundary plan, not implementation。
...
- P275 external channel closure and CI exception record（external channel 收口与 CI 例外记录）已完成；P276 当前推进 real scan / real score / Candidate / Push preview planning。
