...
- Active stop-loss track: `Next Minimal Runtime Slice Selection After DecisionResult Closure`.
...
- Current selection is source-read-lite only and does not change business capability.
