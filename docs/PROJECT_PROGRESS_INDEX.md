...
- `P350 SourceOwnedCandidateIntegrationSourceBindingAssembler Verification` is active on branch `p350`.
...
- The active block is SourceOwnedCandidateIntegrationSourceBindingAssembler Verification.
- The next required business action is `P351 Source-Owned Candidate Integration Runtime Boundary Plan`.
...
Near-term priority after merged P349 / active P350:

1. Complete P350 SourceOwnedCandidateIntegrationSourceBindingAssembler Verification.
2. P351 Source-Owned Candidate Integration Runtime Boundary Plan.
