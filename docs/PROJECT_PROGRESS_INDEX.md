...
- Current HEAD: `e8e9a9f docs(runtime): select hot reset event source status`.
- Active stop-loss track: `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Design`.
...
- Next required action: `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Design`.
