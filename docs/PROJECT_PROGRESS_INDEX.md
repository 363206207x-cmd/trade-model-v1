...
- Current HEAD: `b6f29ac docs(review): verify review archive aggregate readiness`.
- Active stop-loss track: `Minimal Review-Only Review Archive Analytics / Missed Opportunity Aggregate Status Runtime Wiring Verification`.
