...
- Current HEAD: `833b2f6 docs(recheck): gate preview status implementation readiness (#1001)`.
- Active stop-loss track: `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Implementation`.
...
- Next required action: B-risk GPT / human review of the Draft PR; after merge, `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Verification`.
