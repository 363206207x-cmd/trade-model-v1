...
- `P346 SourceOwnedCandidateIntegrationSourceBindingValidator Java Skeleton` is active on branch `p346`.
...
- The active block is SourceOwnedCandidateIntegrationSourceBindingValidator Java Skeleton.
- The next required business action is `P347 SourceOwnedCandidateIntegrationSourceBindingValidator Verification`.
...
Near-term priority after merged P345 / active P346:

1. Complete P346 SourceOwnedCandidateIntegrationSourceBindingValidator Java Skeleton.
2. P347 SourceOwnedCandidateIntegrationSourceBindingValidator Verification.
