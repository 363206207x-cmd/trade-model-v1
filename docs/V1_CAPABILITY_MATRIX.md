...
| Review-only score assembly | REVIEW_ONLY_SCORE_ASSEMBLY_SKELETON | Active P298 PR #731 adds a review-only score assembly DTO and assembler from `ReviewOnlyScoreInputPrecheckDTO`. | No ScoreItem generation, no score calculation, no final score, no direction, no Candidate, no Push, no Readiness, and no point generation. | Score-to-Candidate handoff review-only slice after P298 merges. | Not real ScoreItem, not score calculation, not final score, not direction, not Candidate handoff completion. |
