...
- Current merged main: `40a84e3 docs(recheck): design preview status runtime wiring (#1000)`
...
- Current active block is `Implementation readiness gate for Recheck preview / recheck status`.
- Current next required action is `Implementation readiness gate for Recheck preview / recheck status`; after merge, `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Implementation`.
