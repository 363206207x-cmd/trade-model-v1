...
- Current merged main: `3dfd350 docs(recheck): read preview status source path (#999)`
...
- Current active block is `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Design`.
- Current next required action is `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Design`; after merge, `Implementation readiness gate for Recheck preview / recheck status`.
