...
- Current merged main: `cc225c4 feat(marketquote): show review-only freshness runtime status (#862)`
...
- Current next required action is `MarketQuote visual verification / closure`.
...
- The active MarketQuote verification checks #862 with compile/test, targeted controller/dashboard/market tests, API smoke, dashboard smoke, forbidden path checks, and source-of-truth updates.
...
- The active block is now Minimal Review-Only MarketQuote Freshness Runtime Wiring Verification.
