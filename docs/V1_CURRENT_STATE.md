...
- Current merged main: `5925539 docs(point): define source-owned candidate integration runtime DTO plan (#823)`
...
- Current open business-chain package is branch `p354`: `P354 Source-Owned Candidate Integration Runtime DTO Java Skeleton`.
...
- P354 is the active Source-Owned Candidate Integration Runtime DTO Java Skeleton package.
...
- Fixed next recommended business package after P354 is `P355 Source-Owned Candidate Integration Runtime Validator Plan`, still not runtime implementation.
