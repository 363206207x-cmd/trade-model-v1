...
- Current merged main: `69384bb docs(point): align runtime input missing reason contract (#822)`
...
- Current open business-chain package is branch `p353`: `P353 Source-Owned Candidate Integration Runtime DTO Plan`.
...
- P353 is the active Source-Owned Candidate Integration Runtime DTO Plan package.
...
- Fixed next recommended business package after P353 is `P354 Source-Owned Candidate Integration Runtime DTO Java Skeleton`, still not runtime implementation.
