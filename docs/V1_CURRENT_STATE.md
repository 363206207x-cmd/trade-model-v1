...
- Current merged main: `95d740c feat(evidence-score): show review-only runtime status (#869)`
...
- Current next required action is `Evidence / Score visual verification / closure`.
...
- The active verification package validates the #869 Evidence / Score review-only runtime status surface with compile/test, API smoke, dashboard smoke, forbidden path checks, and source-of-truth updates.
...
- The active block is now Minimal Review-Only Evidence / Score Runtime Wiring Verification.
