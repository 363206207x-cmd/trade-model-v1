...
- Current merged main: `29904a9 feat(dashboard): show review-only positionsync status (#839)`
...
- Current next required action is `Dashboard smoke / visual verification follow-up`.
...
- The active verification checks #839 compile/test results, dashboard static fields, review-only labels, simulated fallback warning, forbidden path boundaries, and runtime smoke.
...
- The active block is now Minimal Review-Only PositionSync Runtime Wiring Verification.
