...
- Current merged main: `bcbeb15 docs(risk): gate account exposure implementation readiness`
...
- Current active block is `Minimal Review-Only Account Risk / Account Exposure Status Runtime Wiring Verification`.
- Current next required action is `Minimal Review-Only Account Risk / Account Exposure Status Runtime Wiring Verification`.
