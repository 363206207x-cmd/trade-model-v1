...
- Current merged main: `6446b59 docs(point): verify source-owned candidate integration validator (#815)`
...
- Current open business-chain package is branch `p348`: `P348 SourceOwnedCandidateIntegrationSourceBindingAssembler Plan`.
...
- P348 is the active SourceOwnedCandidateIntegrationSourceBindingAssembler Plan package.
...
- Fixed next recommended business package after P348 is `P349 SourceOwnedCandidateIntegrationSourceBindingAssembler Java Skeleton`, still not runtime wiring.
