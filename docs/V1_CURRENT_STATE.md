...
- Current merged main: `7d0bb01 docs(point): define source-owned candidate integration assembler plan (#816)`
...
- Current open business-chain package is branch `p349`: `P349 SourceOwnedCandidateIntegrationSourceBindingAssembler Java Skeleton`.
...
- P349 is the active SourceOwnedCandidateIntegrationSourceBindingAssembler Java Skeleton package.
...
- Fixed next recommended business package after P349 is `P350 SourceOwnedCandidateIntegrationSourceBindingAssembler Verification`, still not runtime wiring.
