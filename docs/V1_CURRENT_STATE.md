...
- Current active block is `Next minimal runtime slice selection after Paper Observation / Paper Trading Status closure`.
- Current next required action is `Next minimal runtime slice selection after Paper Observation / Paper Trading Status closure`.
