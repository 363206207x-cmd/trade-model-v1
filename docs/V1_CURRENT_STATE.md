...
- Current merged main: `761af58 docs(runtime): design hot reset event source status`
...
- Current next required action is `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Implementation`.
