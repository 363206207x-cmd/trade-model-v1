...
- Current merged main: `1198d90 docs(point): define source-owned candidate integration runtime validator plan (#825)`
...
- Current open business-chain package is branch `p356`: `P356 Source-Owned Candidate Integration Runtime Validator Java Skeleton`.
...
- P356 is the active Source-Owned Candidate Integration Runtime Validator Java Skeleton package.
...
- Fixed next recommended business package after P356 is `P357 Source-Owned Candidate Integration Runtime Validator Verification`, still not runtime assembler / orchestrator or runtime implementation.
