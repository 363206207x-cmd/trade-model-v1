...
- Current merged main: `701a154 docs(runtime): select recheck preview source read (#998)`
...
- Current active block is `Source Read for Recheck preview / recheck status`.
- Current next required action is `Source Read for Recheck preview / recheck status`; after merge, `Minimal Review-Only Recheck Preview / Recheck Status Runtime Wiring Design`.
