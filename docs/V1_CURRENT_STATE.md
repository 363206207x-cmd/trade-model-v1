...
- Current merged main: `1d87e1d docs(risk): read account exposure source path`
...
- Current active block is `Implementation readiness gate for Account risk / account exposure status`.
- Current next required action is `Implementation readiness gate for Account risk / account exposure status`.
