...
- Current merged main: `e8e9a9f docs(runtime): select hot reset event source status`
...
- Current active block is `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Design`.
- Current next required action is `Minimal Review-Only Hot Reset / Event Impact Source Status Runtime Wiring Design`.
