...
- Current merged main: `e7de3e3 docs(review): verify review archive aggregate runtime wiring`
...
- Current next required action is `Next minimal runtime slice selection after Review Archive Analytics / Missed Opportunity Aggregate Status closure`.
