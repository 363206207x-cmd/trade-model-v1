...
- Current merged main: `fc1f1ac feat(point): add source-owned candidate integration runtime DTO (#824)`
...
- Current open business-chain package is branch `p355`: `P355 Source-Owned Candidate Integration Runtime Validator Plan`.
...
- P355 is the active Source-Owned Candidate Integration Runtime Validator Plan package.
...
- Fixed next recommended business package after P355 is `P356 Source-Owned Candidate Integration Runtime Validator Java Skeleton`, still not runtime assembler / orchestrator or runtime implementation.
