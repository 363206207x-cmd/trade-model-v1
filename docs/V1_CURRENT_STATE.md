...
- Current merged main: `04bddb1 BACKEND-P312 Source-owned Numeric Point Proposal Plan (#759)`
...
- Current open business-chain package is branch `p313`: `BACKEND-P313 SourceTrace Numeric Point Contract Plan` (draft PR pending creation).
...
- P313 is the active docs-only SourceTrace Numeric Point Contract Plan.
...
- P313 does not implement Java, tests, dashboard runtime integration, external channel, order, execution, or auto-trading.
- P313 does not mean SourceTrace Java DTO is complete, numeric point proposal is implemented, or real entry / stop / TP / RR are complete.
- Next recommended package after P313 is RuntimeKlineContext Numeric Point Contract Plan or Numeric Point Safety Validator Plan, not real executable point generation.
