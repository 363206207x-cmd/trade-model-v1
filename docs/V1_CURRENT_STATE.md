...
P289 merged as `c7fa73f`。P289 是 docs-only Scope Pack。P289 收口 P288，并授权 P290 只实现 `MarketReadRequestGuardValidator` Java skeleton。P289 不写 Java，不改 tests，不改 DTO。
