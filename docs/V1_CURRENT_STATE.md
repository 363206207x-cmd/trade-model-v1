...
- Current merged main: `8784976 feat(runtime): show hot reset event source review-only status (#982)`
...
- Current active block is `Hot Reset / Event Impact Source Status Visual Verification / Closure`.
- Current next required action is `Hot Reset / Event Impact Source Status Visual Verification / Closure`.
