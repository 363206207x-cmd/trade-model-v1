...
- Current merged main: `00cee60 docs(runtime): read hot reset event source path`
...
- Current active block is `Implementation readiness gate for Hot Reset / Event Impact Source review-only status`.
- Current next required action is `Implementation readiness gate for Hot Reset / Event Impact Source review-only status`.
