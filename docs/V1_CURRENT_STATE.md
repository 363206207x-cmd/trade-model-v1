...
- Current merged main: `d7c4f99 feat(point): add source-owned candidate integration runtime validator (#826)`
...
- Current open business-chain package is branch `p357`: `P357 Source-Owned Candidate Integration Runtime Validator Verification`.
...
- P357 is the active Source-Owned Candidate Integration Runtime Validator Verification package.
...
- Fixed next recommended business package after P357 is `P358 Source-Owned Candidate Integration Runtime Assembler / Orchestrator Plan`, still not Java assembler / orchestrator implementation or runtime implementation.
