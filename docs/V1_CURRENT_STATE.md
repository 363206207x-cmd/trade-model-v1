...
- Current merged main: `d3a79da feat(risk): show account exposure review-only status`
...
- Current active block is `Account Risk / Account Exposure Status Visual Verification / Closure`.
- Current next required action is `Account Risk / Account Exposure Status Visual Verification / Closure`.
