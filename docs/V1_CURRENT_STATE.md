...
- Current merged main: `47b39c9 feat(point): add source-owned candidate integration source binding assembler (#817)`
...
- Current open business-chain package is branch `p350`: `P350 SourceOwnedCandidateIntegrationSourceBindingAssembler Verification`.
...
- P350 is the active SourceOwnedCandidateIntegrationSourceBindingAssembler Verification package.
...
- Fixed next recommended business package after P350 is `P351 Source-Owned Candidate Integration Runtime Boundary Plan`, still not runtime wiring.
