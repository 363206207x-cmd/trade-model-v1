...
- Current merged main: `823d181 feat(watchlist): show review-only watchlist runtime status (#855)`
...
- Current active block is `Minimal Review-Only Watchlist Runtime Wiring Verification`.
- Current next required action is `Watchlist visual verification / closure`.
...
- The active Minimal Review-Only Watchlist Runtime Wiring Verification validates #855 with compile/test checks, API smoke, dashboard smoke, forbidden path checks, and source-of-truth closure.
...
- The active block is now Minimal Review-Only Watchlist Runtime Wiring Verification.
