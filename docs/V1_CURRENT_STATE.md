...
- Current merged main: `d035e68 docs(point): define source-owned candidate integration boundary (#811)`
...
- Current open business-chain package is branch `p344`: `P344 Source-Owned Candidate Integration Source Binding Plan`.
...
- P344 is the active Source-Owned Candidate Integration Source Binding Plan package.
...
- Fixed next recommended business package after P344 is `P345 SourceOwnedCandidateIntegrationSourceBindingDTO Java Skeleton`, still not runtime wiring.
