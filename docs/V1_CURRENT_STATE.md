...
- Current merged main: `16dabe4 docs(risk): verify account exposure runtime wiring (#976)`
...
- Current active block is `Next minimal runtime slice selection after Account Risk / Account Exposure Status closure`.
- Current next required action is `Next minimal runtime slice selection after Account Risk / Account Exposure Status closure`.
