...
- Current merged main: `8504cb1 feat(review): show review archive aggregate status`
...
- Current active block is `Review Archive Analytics / Missed Opportunity Aggregate Status Visual Verification / Closure`.
- Current next required action is `Review Archive Analytics / Missed Opportunity Aggregate Status Visual Verification / Closure`.
