...
- Current active block is `Next minimal runtime slice selection after RiskActionGuard closure`.
- Current next required action is `Next minimal runtime slice selection after RiskActionGuard closure`.
