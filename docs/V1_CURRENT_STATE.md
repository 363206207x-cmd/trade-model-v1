...
- Current active block is `Next minimal runtime slice selection after Missed Opportunity / Review Archive closure`.
- Current next required action is `Next minimal runtime slice selection after Missed Opportunity / Review Archive closure`.
...
- Missed Opportunity / Review Archive status becomes the 10th completed Review-Only Runtime partial slice after this package is merged.
- The active block after visual closure is Next minimal runtime slice selection after Missed Opportunity / Review Archive closure. The selection package is A-risk docs/source-of-truth only.
