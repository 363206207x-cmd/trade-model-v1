...
- Current merged main: `bfb61c9 BACKEND-P339 DataQualityContext Source Binding Ability Closure (#807)`
...
- Current open business-chain package is branch `p340`: `P340 MultiTimeframeContext Source Binding Ability Closure`.
...
- P340 is the active MultiTimeframeContext Source Binding Ability Closure package.
...
- Fixed next recommended business package after P340 is `RiskActionGuard Source Binding Ability Closure`, still not runtime wiring.
