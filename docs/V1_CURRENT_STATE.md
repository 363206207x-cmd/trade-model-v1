...
- Current active block is `Source Read for Alert fatigue / notification policy status`.
- Current next required action is `Source Read for Alert fatigue / notification policy status`.
