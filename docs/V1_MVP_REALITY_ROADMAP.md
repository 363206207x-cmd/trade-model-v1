...
| candidate attention | Active P300 PR: candidate handoff becomes a review-only candidate attention skeleton, not real Candidate, not candidate rank, not candidate score, not Promote To Home, not Push, not Readiness, and not point generation. | Candidate Preview / Ranking Guard review-only slice. | B | Keep real Candidate ranking, Push, Readiness, and point generation separate. |
...
| review-only Candidate | Candidate Attention / Promote skeleton exists, P299 prepares a handoff envelope, and P300 prepares only a review-only candidate attention envelope. | Candidate Preview / Ranking Guard review-only slice. | B | Can group with internal push preview only if no external send and no production Candidate workflow. |
