...
| internal push preview / recheck handoff | Active P302 PR: candidate preview guard becomes a review-only internal push preview / recheck handoff skeleton with recheck and risk-action guard required. | Push preview closure before external channel. | B | Keep external channel, message rendering/sending, Readiness, and point generation separate. |
...
| internal Opportunity Push preview | No-op/audit/channel skeletons exist, and P302 adds only a review-only internal preview / recheck handoff envelope when merged. | Push preview closure before external channel. | B | Can group with Push Recheck preview only if no external send. |
