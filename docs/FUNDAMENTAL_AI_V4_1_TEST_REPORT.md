...
Status: `FINAL_LOCAL_VALIDATION_COMPLETE_PENDING_EXACT_HEAD_CI`
...
| Provider capability | Exact ADAUSDT, quote/market/contract isolation, dataset-specific enablement, stale directory-only revalidation, HTTP 451, independently authorized fallback, zero-call assertions, direct-client architecture guard, all-unavailable and per-asset isolation |
...
- Full Maven suite: `4610 tests / 4596 passed / 0 failed / 0 errors /
  14 skipped`.
