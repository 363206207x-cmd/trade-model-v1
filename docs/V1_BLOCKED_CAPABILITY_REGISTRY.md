...
| executable point generation pre-approval plan | Docs-only plan active | P311 defines the future source trace, runtime kline context, data quality, multi-timeframe, liquidity / stampede / wick / strong reversal, and Risk Action Guard gates required before numeric point proposal work. |
