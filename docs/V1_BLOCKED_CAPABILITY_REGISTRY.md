...
| MultiTimeframe numeric point contract plan | Docs-only plan active | P316 defines future multi-timeframe fields, 4h / 1h / 15m / 5m roles, alignment states, conflict rules, fixture matrix expectations, and Risk Action Guard references, but it does not create MultiTimeframe Java DTOs or generate values. |
