...
state-contract prerequisites. PR #1155 made the full
...
FE04E_NEXT_PACKAGE: MESSAGE_PUSH_UI_READINESS_AND_GOVERNANCE_REEVALUATION
FE04E_AUTHORIZATION: READ_ONLY_READINESS_REEVALUATION_ONLY
...
FE04E_API_READINESS: PRIVACY_AND_STATE_FOUNDATION_EFFECTIVE_MERGED_MAIN
FE04E_BACKEND_PRIVACY_SANITIZATION: UNIFIED_PUBLIC_PROJECTION_PRIVATE_ORACLE_REMOVAL_AND_ALL_RAW_USER_PUSHRECHECK_ROUTES_DISABLED_EFFECTIVE_MERGED_MAIN
...
NEXT_ALLOWED_ACTION: FE-04E_MESSAGE_PUSH_UI_READINESS_AND_GOVERNANCE_REEVALUATION_ONLY
```
