...
| Exact implementation paths | The ninety-six literal paths in `docs/CODEX_NEXT_TASK.yml`; no wildcard, directory or prefix grant; the three-file AI evidence-canonicalization amendment keeps the package, implementation branch and starting SHA unchanged |
