...
The V42 registration reuses seven exact gate-owner paths and preserves all 49
existing implementation paths, including the root Dockerfile's runtime-stage
`libgomp1` allowance. It adds exactly the 15 native systemd/JAR source and
local-test paths listed in Appendix J.6 and `v42_implementation_allowed_paths`
(64 total). The gate and implementation fingerprints are
`6e1d73813dd16643f7ebeacf2cb4c3c156048396` and
`4262f151a513d7bec00bcc9f0614531d8cae537f`, respectively. Appendix J fixes
...
all existing merge/deployment permission booleans remain unchanged.
